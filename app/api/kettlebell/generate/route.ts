...
export async function POST(req: NextRequest) {
  ...
  const { date, difficulty = 'متوسط', eventType = 'biathlon', focus = 'التحمل' } = body;
...
أرجع JSON بهذا التنسيق:
{
  ...
  "mainWork": [
    {
      ...
      "movementEn": "اسم الحركة بالإنجليزي",
  ...
  "gripwork": {
    "note": "اسلوب الإمساك والتعامل مع التعب في الرسغ",
    "exercises": [
  ...
  "techniqueNotes": ["نقطة تقنية 1", "نقطة تقنية 2"],
