...
⚠️ قاعدة الميتكون الإجبارية — لا تجعل الميتكون معاكساً بالكامل لنمط اليوم: طبّق سطر "الميتكون يجب أن يتضمن..." المذكور لكل نمط ضمن دليل التوافق أعلاه حرفياً (يذكر معرّفات محددة مقترحة لكل نمط). الأكسسوار أيضاً يعزّز نفس مجموعة عضلات نمط اليوم من زاوية مختلفة، لا يعوّض بنمط معاكس — إن جعلت الميتكون معاكساً بحجة أن الأكسسوار سيوازنه، يصبح اليوم يحمل اسم نمط لا يُدرّبه فعلياً (رُصد هذا حرفياً في يوم دفع سابق: القوة فقط كانت دفعاً، والميتكون بالكامل تقريباً سحباً).
        ...
        {"format": "3 SETS", "scoreType": "", "movements": [
          {
            ...
            "reps": "15",
            "weight": "",
            "notes": "طبّق دليل التوافق أعلاه حسب نمط اليوم — اذكر من أي زاوية مختلفة يعزّز هذا التمرين نفس مجموعة عضلات النمط",
            "levels": {
